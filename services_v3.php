    ...
    <div class="wrapper-body"  id="main">
        ...
        <div class="wrapper-customer-success">
            <div class="container">
                ...
                <div class="container wrap-customer-success">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7 col-xlg-7">
                            <div class="customer-text-content">
                                <h3 class="ds-heading">some title</h3>
                                <div class="customer-description">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, quod repellendus. Officia quibusdam voluptatum ipsam sit repellendus. Earum, libero iste reiciendis, voluptatem alias a harum, possimus quia ipsum vitae consectetur!</p>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7 col-xlg-7">
                            <div class="customer-text-content">
                                <h3 class="ds-heading">some title</h3>
                                <div class="customer-description">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique sequi molestiae tempore, et non impedit, quas nisi inventore asperiores voluptatibus reiciendis dignissimos assumenda veritatis autem nesciunt repudiandae accusamus voluptas. Aliquid?</p>
                                </div>
                                <div class="details-success">
                                    <a href="#">
                                        <span>Watch the video</span>
